...
const Login = () => {
  ...
  const handleOAuth = (provider) => {
    ...
    // Si la URL ya termina en /api, no lo agregues de nuevo
    const apiPath = baseURL.endsWith('/api') ? '' : '/api'
    // Construir la URL correcta
    const oauthURL = `${baseURL}${apiPath}/auth/${provider}`
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 backdrop-blur-sm">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4">
            <button
              ...
              className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition font-semibold text-gray-700"
            >
